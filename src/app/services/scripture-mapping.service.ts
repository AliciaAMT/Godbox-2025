...
export class ScriptureMappingService {
  ...
  // Comprehensive mapping of parashot to daily readings
  private readonly parashahReadings: { [key: string]: DailyReadings[] } = {
    'Bereshit': [
      { torah: { book: 'Genesis', chapter: 1, verseStart: 1, verseEnd: 5, reference: 'Genesis 1:1-5' } },
      { torah: { book: 'Genesis', chapter: 1, verseStart: 6, verseEnd: 8, reference: 'Genesis 1:6-8' } },
      { torah: { book: 'Genesis', chapter: 1, verseStart: 9, verseEnd: 13, reference: 'Genesis 1:9-13' } },
      { torah: { book: 'Genesis', chapter: 1, verseStart: 14, verseEnd: 19, reference: 'Genesis 1:14-19' } },
      { torah: { book: 'Genesis', chapter: 1, verseStart: 20, verseEnd: 23, reference: 'Genesis 1:20-23' } },
      { torah: { book: 'Genesis', chapter: 1, verseStart: 24, verseEnd: 31, reference: 'Genesis 1:24-31' } },
      {
        torah: { book: 'Genesis', chapter: 2, verseStart: 1, verseEnd: 3, reference: 'Genesis 2:1-3' },
        prophets: { book: 'Isaiah', chapter: 42, verseStart: 5, verseEnd: 21, reference: 'Isaiah 42:5-21' }
      }
    ],
    'Noach': [
      { torah: { book: 'Genesis', chapter: 6, verseStart: 9, verseEnd: 22, reference: 'Genesis 6:9-22' } },
      { torah: { book: 'Genesis', chapter: 7, verseStart: 1, verseEnd: 16, reference: 'Genesis 7:1-16' } },
      { torah: { book: 'Genesis', chapter: 7, verseStart: 17, verseEnd: 23, reference: 'Genesis 7:17-23' } },
      { torah: { book: 'Genesis', chapter: 7, verseStart: 24, verseEnd: 8, reference: 'Genesis 7:24-8:4' } },
      { torah: { book: 'Genesis', chapter: 8, verseStart: 5, verseEnd: 14, reference: 'Genesis 8:5-14' } },
      { torah: { book: 'Genesis', chapter: 8, verseStart: 15, verseEnd: 22, reference: 'Genesis 8:15-22' } },
      {
        torah: { book: 'Genesis', chapter: 9, verseStart: 1, verseEnd: 7, reference: 'Genesis 9:1-7' },
        prophets: { book: 'Isaiah', chapter: 54, verseStart: 9, verseEnd: 10, reference: 'Isaiah 54:9-10' }
      }
    ],
    'Lech Lecha': [
    ...
    'Pinchas': [
      { torah: { book: 'Numbers', chapter: 25, verseStart: 10, verseEnd: 18, reference: 'Numbers 25:10-18' } },
      { torah: { book: 'Numbers', chapter: 26, verseStart: 1, verseEnd: 11, reference: 'Numbers 26:1-11' } },
      { torah: { book: 'Numbers', chapter: 26, verseStart: 12, verseEnd: 34, reference: 'Numbers 26:12-34' } },
      { torah: { book: 'Numbers', chapter: 26, verseStart: 35, verseEnd: 51, reference: 'Numbers 26:35-51' } },
      { torah: { book: 'Numbers', chapter: 26, verseStart: 52, verseEnd: 65, reference: 'Numbers 26:52-65' } },
      { torah: { book: 'Numbers', chapter: 27, verseStart: 1, verseEnd: 11, reference: 'Numbers 27:1-11' } },
      {
        torah: { book: 'Numbers', chapter: 27, verseStart: 12, verseEnd: 23, reference: 'Numbers 27:12-23' },
        prophets: { book: '1 Kings', chapter: 18, verseStart: 46, verseEnd: 19, reference: '1 Kings 18:46-19:21' }
      }
    ]
  };
